      ...
      {eintraege.map((s, i) => (
        <li key={s.slug} className="border-b border-current/15" data-reveal>
          ...
          >
            ...
            <div
              aria-hidden="true"
              className="absolute inset-0 hidden opacity-0 transition-opacity duration-[var(--dauer-2)] ease-[var(--ease-out)] group-hover:opacity-100 group-focus-visible:opacity-100 md:block"
            >
              <div className="h-full w-full scale-[1.06] transition-transform duration-[var(--dauer-3)] ease-[var(--ease-soft)] group-hover:scale-100">
            ...
            <div className="wrap relative z-[1] grid items-center gap-x-[var(--s-6)] gap-y-[var(--s-3)] py-[clamp(28px,6.5svh,64px)] md:grid-cols-[3.2rem_minmax(0,1fr)_minmax(0,36ch)_2.4rem]">
              ...
              <span
                aria-hidden="true"
                className="hidden -translate-x-2 text-[1.7rem] opacity-0 transition-[opacity,transform] duration-[var(--dauer-2)] ease-[var(--ease-out)] group-hover:translate-x-0 group-hover:opacity-100 group-focus-visible:translate-x-0 group-focus-visible:opacity-100 md:block"
              >
                →
              </span>
            </div>
